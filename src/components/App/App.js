...
class App extends Component {
  constructor(props, context) {
    ...
    this._toggleDebt = () => this._toggle('has_debt');
    this._toggle401k = () => this._toggle('has_401k');
    this._toggleRetirement = () => this._toggle('has_other_retirement');
    this._toggleOther = () => this._toggle('has_other_account');
  ...
  _handleSubmit(){
    this.completeForm = initialState
  ...
  //   const hasDebt = this.state.numDebt > 0 ? true :  false
  //   this.setState(prevState => ({
  ...
  render() {
    const newDebt = this.state.debtData.map((debt) => {
